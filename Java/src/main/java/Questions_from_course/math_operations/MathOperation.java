package Questions_from_course.math_operations;
...
public class MathOperation {
  public static void main(String[] args) {
    ...
    // The absolute value of a number is equal to its poistive no
    // to the number if the number is positive or zero and
    // equal to the negative of the number if the number is negative.
    // Absolute value means it converts the negative value to a positive value.
    // like wise  |-9| after applying the value to absolute then it wil be 9
    System.out.println("Absolute(.abs) value of a poistive no is |" + i + "| is " + Math.abs(i));
    System.out.println("Absolute(.abs) value of a negative no is |" + j + "| is " + Math.abs(j));
